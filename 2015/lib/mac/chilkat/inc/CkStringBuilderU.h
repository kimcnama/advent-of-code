...
class CK_VISIBLE_PUBLIC CkStringBuilderU  : public CkUtf16Base
{
	...
	bool DecodeAndAppend(const uint16_t *value, const uint16_t *encoding, const uint16_t *charset);
	...
	// the value of removeFlag. This is fixed in v9.5.0.89.
	// 
	const uint16_t *getRange(int startIndex, int numChars, bool removeFlag);
	// Returns a string containing the specified range of characters from this
	// instance. If removeFlag is true, then the range of chars is removed from this
	// instance.
	// 
	...
	// the value of removeFlag. This is fixed in v9.5.0.89.
	// 
	const uint16_t *range(int startIndex, int numChars, bool removeFlag);
	...
	// number of replacements.
	int ReplaceNoCase(const uint16_t *value, const uint16_t *replacement);
