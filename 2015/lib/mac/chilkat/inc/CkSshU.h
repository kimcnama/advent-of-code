// CkSshU.h: interface for the CkSshU class.
//
//////////////////////////////////////////////////////////////////////
...
// CLASS: CkSshU
class CK_VISIBLE_PUBLIC CkSshU  : public CkClassWithCallbacksU
{
	public:
	bool m_cbOwned;
	...
	static CkSshU *createNew(void);
	

	CkSshU(bool bCallbackOwned);
	static CkSshU *createNew(bool bCallbackOwned);
	...
	// The descriptive text corresponding to the ChannelOpenFailCode property.
	const uint16_t *channelOpenFailReason(void);
	...
	// Indicates the charset to be used for the command sent via the SendReqExec
	// method. The default is "ANSI". A likely alternate value would be "utf-8".
	const uint16_t *reqExecCharset(void);
	// Indicates the charset to be used for the command sent via the SendReqExec
	// method. The default is "ANSI". A likely alternate value would be "utf-8".
	void put_ReqExecCharset(const uint16_t *newVal);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelPollAsync(int channelNum, int pollTimeoutMs);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelReadAsync(int channelNum);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelReadAndPollAsync(int channelNum, int pollTimeoutMs);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelReadAndPoll2Async(int channelNum, int pollTimeoutMs, int maxNumBytes);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelReceiveToCloseAsync(int channelNum);
	...
	// 
	bool ChannelReceiveUntilMatch(int channelNum, const uint16_t *matchPattern, const uint16_t *charset, bool caseSensitive);
	...
	// v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelReceiveUntilMatchAsync(int channelNum, const uint16_t *matchPattern, const uint16_t *charset, bool caseSensitive);
	...
	// 
	bool ChannelReceiveUntilMatchN(int channelNum, CkStringArrayU &matchPatterns, const uint16_t *charset, bool caseSensitive);

	// Creates an asynchronous task to call the ChannelReceiveUntilMatchN method with
	// the arguments provided. (Async methods are available starting in Chilkat
	// v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelReceiveUntilMatchNAsync(int channelNum, CkStringArrayU &matchPatterns, const uint16_t *charset, bool caseSensitive);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelSendCloseAsync(int channelNum);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelSendDataAsync(int channelNum, CkByteData &byteData);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelSendEofAsync(int channelNum);
	...
	bool ChannelSendString(int channelNum, const uint16_t *textData, const uint16_t *charset);

	// Creates an asynchronous task to call the ChannelSendString method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ChannelSendStringAsync(int channelNum, const uint16_t *textData, const uint16_t *charset);
	...
	// of authentication to be used, and this method is never called.)
	// 
	const uint16_t *getAuthMethods(void);
	// Queries the SSH server to find out which authentication methods it supports.
	// Returns a string such as "publickey,password,keyboard-interactive".
	// 
	// This method should be called after connecting, but prior to authenticating. The
	...
	// Returns a string describing the channel type for the Nth open channel. Channel
	// types are: "session", "x11", "forwarded-tcpip", and "direct-tcpip".
	const uint16_t *getChannelType(int index);
	// Returns a string describing the channel type for the Nth open channel. Channel
	// types are: "session", "x11", "forwarded-tcpip", and "direct-tcpip".
	const uint16_t *channelType(int index);
	...
	// <http://www.chilkatsoft.com/p/p_463.asp>.
	bool GetReceivedStderrText(int channelNum, const uint16_t *charset, CkString &outStr);
	// Returns the accumulated stderr text received on the channel indicated by channelNum
	// and clears the channel's internal receive buffer. The charset indicates the charset
	// of the character data in the internal receive buffer. A list of supported
	// charset values may be found on this page:Supported Charsets
	// <http://www.chilkatsoft.com/p/p_463.asp>.
	const uint16_t *getReceivedStderrText(int channelNum, const uint16_t *charset);
	// Returns the accumulated stderr text received on the channel indicated by channelNum
	// and clears the channel's internal receive buffer. The charset indicates the charset
	// of the character data in the internal receive buffer. A list of supported
	// charset values may be found on this page:Supported Charsets
	// <http://www.chilkatsoft.com/p/p_463.asp>.
	const uint16_t *receivedStderrText(int channelNum, const uint16_t *charset);
	...
	// values may be found on this page:Supported Charsets
	// <http://www.chilkatsoft.com/p/p_463.asp>.
	bool GetReceivedText(int channelNum, const uint16_t *charset, CkString &outStr);
	// Returns the accumulated text received on the channel indicated by channelNum and
	// clears the channel's internal receive buffer. The charset indicates the charset of
	// the character data in the internal receive buffer. A list of supported charset
	// values may be found on this page:Supported Charsets
	// <http://www.chilkatsoft.com/p/p_463.asp>.
	const uint16_t *getReceivedText(int channelNum, const uint16_t *charset);
	// Returns the accumulated text received on the channel indicated by channelNum and
	// clears the channel's internal receive buffer. The charset indicates the charset of
	// the character data in the internal receive buffer. A list of supported charset
	// values may be found on this page:Supported Charsets
	// <http://www.chilkatsoft.com/p/p_463.asp>.
	const uint16_t *receivedText(int channelNum, const uint16_t *charset);
	...
	bool GetReceivedTextS(int channelNum, const uint16_t *substr, const uint16_t *charset, CkString &outStr);
	// The same as GetReceivedText, except only the text up to and including substr is
	// returned. The text returned is removed from the internal receive buffer. If the
	// substr was not found in the internal receive buffer, an empty string is returned
	// and the internal receive buffer is not modified.
	const uint16_t *getReceivedTextS(int channelNum, const uint16_t *substr, const uint16_t *charset);
	// The same as GetReceivedText, except only the text up to and including substr is
	// returned. The text returned is removed from the internal receive buffer. If the
	// substr was not found in the internal receive buffer, an empty string is returned
	// and the internal receive buffer is not modified.
	const uint16_t *receivedTextS(int channelNum, const uint16_t *substr, const uint16_t *charset);
	...
	// 
	int OpenCustomChannel(const uint16_t *channelType);

	// Creates an asynchronous task to call the OpenCustomChannel method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *OpenCustomChannelAsync(const uint16_t *channelType);
	...
	// passed to any method requiring a channel number. A -1 is returned upon failure.
	// 
	int OpenDirectTcpIpChannel(const uint16_t *targetHostname, int targetPort);

	// Creates an asynchronous task to call the OpenDirectTcpIpChannel method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *OpenDirectTcpIpChannelAsync(const uint16_t *targetHostname, int targetPort);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *OpenSessionChannelAsync(void);

	// This is the same as GetReceivedText, except the internal receive buffer is not
	// cleared.
	bool PeekReceivedText(int channelNum, const uint16_t *charset, CkString &outStr);
	// This is the same as GetReceivedText, except the internal receive buffer is not
	// cleared.
	const uint16_t *peekReceivedText(int channelNum, const uint16_t *charset);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *QuickCmdCheckAsync(int pollTimeoutMs);
	...
	// LastErrorText property to support@chilkatsoft.com.
	// 
	int QuickCmdSend(const uint16_t *command);

	// Creates an asynchronous task to call the QuickCmdSend method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *QuickCmdSendAsync(const uint16_t *command);
	...
	// LastErrorText property to support@chilkatsoft.com.
	// 
	bool QuickCommand(const uint16_t *command, const uint16_t *charset, CkString &outStr);
	// Simplified method for executing a remote command and getting the complete
	// output. This is the equivalent of calling OpenSessionChannel, followed by
	// SendReqExec, then ChannelReceiveToClose, and finally GetReceivedText.
	// 
	...
	// LastErrorText property to support@chilkatsoft.com.
	// 
	const uint16_t *quickCommand(const uint16_t *command, const uint16_t *charset);

	// Creates an asynchronous task to call the QuickCommand method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *QuickCommandAsync(const uint16_t *command, const uint16_t *charset);
	...
	// 
	bool SendReqExec(int channelNum, const uint16_t *commandLine);

	// Creates an asynchronous task to call the SendReqExec method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqExecAsync(int channelNum, const uint16_t *commandLine);
	...
	// 
	bool SendReqPty(int channelNum, const uint16_t *termType, int widthInChars, int heightInChars, int widthInPixels, int heightInPixels);

	// Creates an asynchronous task to call the SendReqPty method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqPtyAsync(int channelNum, const uint16_t *termType, int widthInChars, int heightInChars, int widthInPixels, int heightInPixels);

	// Sets an environment variable in the remote shell.
	bool SendReqSetEnv(int channelNum, const uint16_t *name, const uint16_t *value);

	// Creates an asynchronous task to call the SendReqSetEnv method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqSetEnvAsync(int channelNum, const uint16_t *name, const uint16_t *value);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqShellAsync(int channelNum);
	...
	// Unix/Linux system.)
	bool SendReqSignal(int channelNum, const uint16_t *signalName);

	// Creates an asynchronous task to call the SendReqSignal method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqSignalAsync(int channelNum, const uint16_t *signalName);
	...
	// subsystem.
	bool SendReqSubsystem(int channelNum, const uint16_t *subsystemName);

	// Creates an asynchronous task to call the SendReqSubsystem method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqSubsystemAsync(int channelNum, const uint16_t *subsystemName);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqWindowChangeAsync(int channelNum, int widthInChars, int heightInRows, int pixWidth, int pixHeight);
	...
	bool SendReqX11Forwarding(int channelNum, bool singleConnection, const uint16_t *authProt, const uint16_t *authCookie, int screenNum);

	// Creates an asynchronous task to call the SendReqX11Forwarding method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqX11ForwardingAsync(int channelNum, bool singleConnection, const uint16_t *authProt, const uint16_t *authCookie, int screenNum);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendReqXonXoffAsync(int channelNum, bool clientCanDo);
	...
	// 
	bool SetTtyMode(const uint16_t *ttyName, int ttyValue);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *WaitForChannelMessageAsync(int pollTimeoutMs);
