// CkTaskU.h: interface for the CkTaskU class.
//
//////////////////////////////////////////////////////////////////////
...
// CLASS: CkTaskU
class CK_VISIBLE_PUBLIC CkTaskU  : public CkUtf16Base
{
	...
	CkTaskU(const CkTaskU &);
	CkTaskU &operator=(const CkTaskU &);

    public:
	CkTaskU(void);
	virtual ~CkTaskU(void);

	

	static CkTaskU *createNew(void);
	...
	// The LastErrorText for the task's asynchronous method.
	const uint16_t *resultErrorText(void);
	...
	// available via the GetResultBool method.
	// 
	const uint16_t *resultType(void);
	...
	// Returns the string result of the task.
	const uint16_t *getResultString(void);
	// Returns the string result of the task.
	const uint16_t *resultString(void);
	...
	// Returns the name of the Nth progress info event logged. The 1st entry is at
	// index 0.
	const uint16_t *progressInfoName(int index);
	...
	// Returns the value of the Nth progress info event logged. The 1st entry is at
	// index 0.
	const uint16_t *progressInfoValue(int index);
