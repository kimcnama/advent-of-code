// CkSocketU.h: interface for the CkSocketU class.
//
//////////////////////////////////////////////////////////////////////
...
// CLASS: CkSocketU
class CK_VISIBLE_PUBLIC CkSocketU  : public CkClassWithCallbacksU
{
	public:
	bool m_cbOwned;
	...
	CkSocketU(const CkSocketU &);
	CkSocketU &operator=(const CkSocketU &);

    public:
	CkSocketU(void);
	virtual ~CkSocketU(void);

	

	static CkSocketU *createNew(void);
	

	CkSocketU(bool bCallbackOwned);
	static CkSocketU *createNew(bool bCallbackOwned);
	...
	// This causes the ALPN extension to be added to the TLS ClientHello with the given
	// ALPN protocol name.
	const uint16_t *alpnProtocol(void);
	// For TLS connections. Can be set to the name of an application layer protocol.
	// This causes the ALPN extension to be added to the TLS ClientHello with the given
	// ALPN protocol name.
	void put_AlpnProtocol(const uint16_t *newVal);
	...
	// The local IP address for a bound or connected socket.
	const uint16_t *localIpAddress(void);
	...
	// bound or connected socket.
	// 
	const uint16_t *myIpAddress(void);
	...
	// When a socket is connected, the remote IP address of the connected peer is
	// available in this property.
	const uint16_t *remoteIpAddress(void);
	...
	// single-quote, etc.
	// 
	const uint16_t *sessionLogEncoding(void);
	// Controls how the data is encoded in the SessionLog. Possible values are "esc"
	// and "hex". The default value is "esc".
	// 
	// When set to "hex", the bytes are encoded as a hexidecimalized string. The "esc"
	...
	// single-quote, etc.
	// 
	void put_SessionLogEncoding(const uint16_t *newVal);
	...
	// hostname is desired. (Normally, Chilkat automatically uses the domain name in
	// the SNI hostname TLS ClientHello extension.)
	const uint16_t *sniHostname(void);
	// Specifies the SNI hostname to be used in the TLS ClientHello. This property is
	// only needed when the domain is specified via a dotted IP address and an SNI
	// hostname is desired. (Normally, Chilkat automatically uses the domain name in
	// the SNI hostname TLS ClientHello extension.)
	void put_SniHostname(const uint16_t *newVal);
	...
	// charset if necessary. This ONLY APPLIES TO THE SendString and ReceiveString
	// methods. The default value is "ansi".
	const uint16_t *stringCharset(void);
	// A charset such as "utf-8", "windows-1252", "Shift_JIS", "iso-8859-1", etc.
	// Methods for sending and receiving strings will use this charset as the encoding.
	// Strings sent on the socket are first converted (if necessary) to this encoding.
	// When reading, it is assumed that the bytes received are converted FROM this
	// charset if necessary. This ONLY APPLIES TO THE SendString and ReceiveString
	// methods. The default value is "ansi".
	void put_StringCharset(const uint16_t *newVal);
	...
	// application might use this property to keep extra information associated with
	// the socket.
	const uint16_t *userData(void);
	// Provides a way to store text data with the socket object. The UserData is purely
	// for convenience and is not involved in the socket communications in any way. An
	// application might use this property to keep extra information associated with
	// the socket.
	void put_UserData(const uint16_t *newVal);
	...
	// InitSslServer.
	// 
	bool AddSslAcceptableClientCaDn(const uint16_t *certAuthDN);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *BindAndListenAsync(int port, int backLog);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *BindAndListenPortRangeAsync(int beginPort, int endPort, int backLog);

	// Convenience method for building a simple HTTP GET request from a URL.
	bool BuildHttpGetRequest(const uint16_t *url, CkString &outStr);
	// Convenience method for building a simple HTTP GET request from a URL.
	const uint16_t *buildHttpGetRequest(const uint16_t *url);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *CheckWriteableAsync(int maxWaitMs);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *CloseAsync(int maxWaitMs);
	...
	// 
	bool Connect(const uint16_t *hostname, int port, bool ssl, int maxWaitMs);

	// Creates an asynchronous task to call the Connect method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ConnectAsync(const uint16_t *hostname, int port, bool ssl, int maxWaitMs);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ConvertFromSslAsync(void);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ConvertToSslAsync(void);
	...
	bool DnsLookup(const uint16_t *hostname, int maxWaitMs, CkString &outStr);
	// Performs a DNS query to resolve a hostname to an IP address. The IP address is
	// returned if successful. The maximum time to wait (in milliseconds) is passed in
	// maxWaitMs. To wait indefinitely, set maxWaitMs = 0.
	const uint16_t *dnsLookup(const uint16_t *hostname, int maxWaitMs);

	// Creates an asynchronous task to call the DnsLookup method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *DnsLookupAsync(const uint16_t *hostname, int maxWaitMs);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkCertU *GetReceivedClientCert(int index);
	...
	// get the Distinguished Name (DN) of each acceptable CA. The index should range
	// from 0 to NumSslAcceptableClientCAs - 1.
	const uint16_t *getSslAcceptableClientCaDn(int index);
	// If connected as an SSL/TLS client to an SSL/TLS server where the server requires
	// a client-side certificate for authentication, then the NumSslAcceptableClientCAs
	// property contains the number of acceptable certificate authorities sent by the
	// server during connection establishment handshake. This method may be called to
	// get the Distinguished Name (DN) of each acceptable CA. The index should range
	// from 0 to NumSslAcceptableClientCAs - 1.
	const uint16_t *sslAcceptableClientCaDn(int index);
	...
	bool InitSslServer(CkCertU &cert);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *PollDataAvailableAsync(void);
	...
	bool ReceiveBdN(unsigned long numBytes, CkBinDataU &binData);

	// Creates an asynchronous task to call the ReceiveBdN method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveBdNAsync(unsigned long numBytes, CkBinDataU &binData);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveByteAsync(bool bUnsigned);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveBytesAsync(void);
	...
	bool ReceiveBytesENC(const uint16_t *encodingAlg, CkString &outStr);
	// The same as ReceiveBytes, except the bytes are returned in encoded string form
	// according to encodingAlg. The encodingAlg can be "Base64", "modBase64", "Base32", "UU", "QP"
	// (for quoted-printable), "URL" (for url-encoding), "Hex", "Q", "B", "url_oath",
	// "url_rfc1738", "url_rfc2396", or "url_rfc3986".
	const uint16_t *receiveBytesENC(const uint16_t *encodingAlg);

	// Creates an asynchronous task to call the ReceiveBytesENC method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveBytesENCAsync(const uint16_t *encodingAlg);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveBytesNAsync(unsigned long numBytes);
	...
	// 
	bool ReceiveBytesToFile(const uint16_t *appendFilename);

	// Creates an asynchronous task to call the ReceiveBytesToFile method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveBytesToFileAsync(const uint16_t *appendFilename);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveCountAsync(void);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveInt16Async(bool bigEndian, bool bUnsigned);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveInt32Async(bool bigEndian);
	...
	bool ReceiveNBytesENC(unsigned long numBytes, const uint16_t *encodingAlg, CkString &outStr);
	// The same as ReceiveBytesN, except the bytes are returned in encoded string form
	// using the encoding specified by numBytes. The numBytes can be "Base64", "modBase64",
	// "Base32", "UU", "QP" (for quoted-printable), "URL" (for url-encoding), "Hex",
	// "Q", "B", "url_oath", "url_rfc1738", "url_rfc2396", or "url_rfc3986".
	const uint16_t *receiveNBytesENC(unsigned long numBytes, const uint16_t *encodingAlg);

	// Creates an asynchronous task to call the ReceiveNBytesENC method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveNBytesENCAsync(unsigned long numBytes, const uint16_t *encodingAlg);
	...
	bool ReceiveSb(CkStringBuilderU &sb);

	// Creates an asynchronous task to call the ReceiveSb method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveSbAsync(CkStringBuilderU &sb);
	...
	// StringCharset property and returned as a string.)
	// 
	const uint16_t *receiveStringMaxN(int maxByteCount);

	// Creates an asynchronous task to call the ReceiveStringMaxN method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveStringMaxNAsync(int maxByteCount);
	...
	// value is read. Returns a string containing all the bytes up to but excluding the
	// lookForByte.
	const uint16_t *receiveStringUntilByte(int lookForByte);

	// Creates an asynchronous task to call the ReceiveStringUntilByte method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveStringUntilByteAsync(int lookForByte);
	...
	// interpreted according to the charset specified by the StringCharset property.
	bool ReceiveUntilMatch(const uint16_t *matchStr, CkString &outStr);
	// Reads text from the connected TCP/IP or SSL socket until a matching string
	// (matchStr) is received. Returns the text up to and including the matching string. As
	// an example, to one might read the header of an HTTP request or a MIME message by
	// reading up to the first double CRLF ("\r\n\r\n"). The incoming bytes are
	// interpreted according to the charset specified by the StringCharset property.
	const uint16_t *receiveUntilMatch(const uint16_t *matchStr);

	// Creates an asynchronous task to call the ReceiveUntilMatch method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *ReceiveUntilMatchAsync(const uint16_t *matchStr);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SelectForReadingAsync(int timeoutMs);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SelectForWritingAsync(int timeoutMs);
	...
	// 
	bool SendBd(CkBinDataU &binData, unsigned long offset, unsigned long numBytes);

	// Creates an asynchronous task to call the SendBd method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendBdAsync(CkBinDataU &binData, unsigned long offset, unsigned long numBytes);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendByteAsync(int value);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendBytesAsync(CkByteData &data);
	...
	bool SendBytesENC(const uint16_t *encodedBytes, const uint16_t *encodingAlg);

	// Creates an asynchronous task to call the SendBytesENC method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendBytesENCAsync(const uint16_t *encodedBytes, const uint16_t *encodingAlg);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendCountAsync(int byteCount);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendInt16Async(int value, bool bigEndian);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendInt32Async(int value, bool bigEndian);
	...
	// sent.
	// 
	bool SendString(const uint16_t *stringToSend);

	// Creates an asynchronous task to call the SendString method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendStringAsync(const uint16_t *stringToSend);
	...
	// 
	bool SendWakeOnLan(const uint16_t *macAddress, int port, const uint16_t *ipBroadcastAddr);
	...
	bool SendWakeOnLan2(const uint16_t *macAddress, int port, const uint16_t *ipBroadcastAddr, const uint16_t *password);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkSocketU *SshOpenChannel(const uint16_t *hostname, int port, bool ssl, int maxWaitMs);

	// Creates an asynchronous task to call the SshOpenChannel method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SshOpenChannelAsync(const uint16_t *hostname, int port, bool ssl, int maxWaitMs);
	...
	bool TakeConnection(CkSocketU &sock);
	...
	bool TakeSocket(CkSocketU &sock);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *TlsRenegotiateAsync(void);
