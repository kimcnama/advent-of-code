// CkTaskChainU.h: interface for the CkTaskChainU class.
//
//////////////////////////////////////////////////////////////////////

// This header is generated for Chilkat 9.5.0.89

#ifndef _CkTaskChainU_H
#define _CkTaskChainU_H
...
// CLASS: CkTaskChainU
class CK_VISIBLE_PUBLIC CkTaskChainU  : public CkUtf16Base
{
	...
	CkTaskChainU(const CkTaskChainU &);
	CkTaskChainU &operator=(const CkTaskChainU &);

    public:
	CkTaskChainU(void);
	virtual ~CkTaskChainU(void);

	

	static CkTaskChainU *createNew(void);
