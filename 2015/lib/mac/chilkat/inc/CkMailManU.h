// CkMailManU.h: interface for the CkMailManU class.
//
//////////////////////////////////////////////////////////////////////

// This header is generated for Chilkat 9.5.0.89

#ifndef _CkMailManU_H
#define _CkMailManU_H
...
// CLASS: CkMailManU
class CK_VISIBLE_PUBLIC CkMailManU  : public CkClassWithCallbacksU
{
	public:
	bool m_cbOwned;
	...
	CkMailManU(const CkMailManU &);
	CkMailManU &operator=(const CkMailManU &);

    public:
	CkMailManU(void);
	virtual ~CkMailManU(void);

	

	static CkMailManU *createNew(void);
	

	CkMailManU(bool bCallbackOwned);
	static CkMailManU *createNew(bool bCallbackOwned);
	...
	CkMailManProgressU *get_EventCallbackObject(void) const;
	void put_EventCallbackObject(CkMailManProgressU *progress);
	...
	// (An SMTP DSN service extension feature) An arbitrary string that will be used as
	// the ENVID property when sending email. See RFC 3461 for more details.
	const uint16_t *dsnEnvid(void);
	// (An SMTP DSN service extension feature) An arbitrary string that will be used as
	// the ENVID property when sending email. See RFC 3461 for more details.
	void put_DsnEnvid(const uint16_t *newVal);
	...
	// be left blank, or can be set to "NEVER", or any combination of a comma-separated
	// list of "SUCCESS", "FAILURE", or "NOTIFY".
	const uint16_t *dsnNotify(void);
	// (An SMTP DSN service extension feature) A string that will be used as the NOTIFY
	// parameter when sending email. (See RFC 3461 for more details. ) This string can
	// be left blank, or can be set to "NEVER", or any combination of a comma-separated
	// list of "SUCCESS", "FAILURE", or "NOTIFY".
	void put_DsnNotify(const uint16_t *newVal);
	...
	// be left blank, or can be set to "FULL" to receive entire-message DSN
	// notifications, or "HDRS" to receive header-only DSN notifications.
	const uint16_t *dsnRet(void);
	// (An SMTP DSN service extension feature) A string that will be used as the RET
	// parameter when sending email. (See RFC 3461 for more details. ) This string can
	// be left blank, or can be set to "FULL" to receive entire-message DSN
	// notifications, or "HDRS" to receive header-only DSN notifications.
	void put_DsnRet(const uint16_t *newVal);
	...
	// The logical operators are: AND, OR, NOT (case insensitive) 
	// Comparison operators are: =, , =, String comparison operators are: CONTAINS, LIKE (case insensitive)
	void put_Filter(const uint16_t *newVal);
	...
	// server. By default, this property is an empty string which causes the local
	// hostname to be used.
	const uint16_t *heloHostname(void);
	// Specifies the hostname to be used for the EHLO/HELO command sent to an SMTP
	// server. By default, this property is an empty string which causes the local
	// hostname to be used.
	void put_HeloHostname(const uint16_t *newVal);
	...
	// The name of the file created in the SMTPQ's queue directory for the last email
	// sent via SendQ, SendQ2, or SendMimeQ.
	const uint16_t *lastSendQFilename(void);
#endif
	...
	// Returns the last SMTP status message associated with the last SMTP status code
	// received. This can be checked after sending an email.
	const uint16_t *lastSmtpStatusMsg(void);
	...
	// A log filename where the MailMan will log each message in the exact form it was
	// received from a POP3 server. This property is provided for help in debugging.
	const uint16_t *logMailReceivedFilename(void);
	// A log filename where the MailMan will log each message in the exact form it was
	// received from a POP3 server. This property is provided for help in debugging.
	void put_LogMailReceivedFilename(const uint16_t *newVal);
	...
	// A log filename where the MailMan will log the exact message sent to the SMTP
	// server. This property is helpful in debugging.
	const uint16_t *logMailSentFilename(void);
	// A log filename where the MailMan will log the exact message sent to the SMTP
	// server. This property is helpful in debugging.
	void put_LogMailSentFilename(const uint16_t *newVal);
	...
	// This property may also be set to an IP address string, such as "168.144.70.227".
	// Both IPv4 and IPv6 address formats are supported.
	const uint16_t *mailHost(void);
	// The domain name of the POP3 server. Do not include "http://" in the domain name.
	// This property may also be set to an IP address string, such as "168.144.70.227".
	// Both IPv4 and IPv6 address formats are supported.
	void put_MailHost(const uint16_t *newVal);
	...
	// authentication for POP3 sessions (pop.gmail.com).
	// 
	const uint16_t *oAuth2AccessToken(void);
	// The OAUTH2 access token if OAUTH2 authentication is to be used for the
	// authentication. For GMail, the Chilkat HTTP class/object's G_SvcOauthAccessToken
	// method can be called to obtain an OAUTH2 access token for a GMail service
	// account.
	...
	// authentication for POP3 sessions (pop.gmail.com).
	// 
	void put_OAuth2AccessToken(const uint16_t *newVal);
	...
	// The filename attribute to be used in the Content-Disposition header field when
	// sending a PCKS7 encrypted email. The default value is "smime.p7m".
	const uint16_t *p7mEncryptAttachFilename(void);
	// The filename attribute to be used in the Content-Disposition header field when
	// sending a PCKS7 encrypted email. The default value is "smime.p7m".
	void put_P7mEncryptAttachFilename(const uint16_t *newVal);
	...
	// The filename attribute to be used in the Content-Disposition header field when
	// sending a PCKS7 opaque signed email. The default value is "smime.p7m".
	const uint16_t *p7mSigAttachFilename(void);
	// The filename attribute to be used in the Content-Disposition header field when
	// sending a PCKS7 opaque signed email. The default value is "smime.p7m".
	void put_P7mSigAttachFilename(const uint16_t *newVal);
	...
	// sending a signed email with a detached PKCS7 signature. The default value is
	// "smime.p7s".
	const uint16_t *p7sSigAttachFilename(void);
	// The filename attribute to be used in the Content-Disposition header field when
	// sending a signed email with a detached PKCS7 signature. The default value is
	// "smime.p7s".
	void put_P7sSigAttachFilename(const uint16_t *newVal);
	...
	// the raw responses received from the POP3 server. This property is read-only, but
	// it may be cleared by calling ClearPop3SessionLog.
	const uint16_t *pop3SessionLog(void);
	...
	// logged-on credentials (of the calling process) for authentication.
	// 
	const uint16_t *popPassword(void);
	// The POP3 password.
	// 
	// If the Pop3SPA property is set, the PopUsername and PopPassword properties may
	// be set to the string "default" to cause the component to use the current
	// logged-on credentials (of the calling process) for authentication.
	// 
	void put_PopPassword(const uint16_t *newVal);

	// Provides a way to specify the POP3 password from a Base64-encoded string.
	void get_PopPasswordBase64(CkString &str);
	// Provides a way to specify the POP3 password from a Base64-encoded string.
	const uint16_t *popPasswordBase64(void);
	// Provides a way to specify the POP3 password from a Base64-encoded string.
	void put_PopPasswordBase64(const uint16_t *newVal);
	...
	// logged-on credentials (of the calling process) for authentication.
	// 
	const uint16_t *popUsername(void);
	// The POP3 login name.
	// 
	// If the Pop3SPA property is set, the PopUsername and PopPassword properties may
	// be set to the string "default" to cause the component to use the current
	// logged-on credentials (of the calling process) for authentication.
	// 
	void put_PopUsername(const uint16_t *newVal);
	...
	// property equal to 1 and then retry.
	// 
	const uint16_t *smtpAuthMethod(void);
	// This property should usually be left empty. The MailMan will by default choose
	// the most secure login method available to prevent unencrypted username and
	// passwords from being transmitted if possible. However, some SMTP servers may not
	// advertise the acceptable authorization methods, and therefore it is not possible
	...
	// property equal to 1 and then retry.
	// 
	void put_SmtpAuthMethod(const uint16_t *newVal);
	...
	//     InternalFailure An internal failure that should be reported to Chilkat
	//     support.
	const uint16_t *smtpFailReason(void);
	...
	// This property may also be set to an IP address string, such as "168.144.70.227".
	// Both IPv4 and IPv6 address formats are supported.
	const uint16_t *smtpHost(void);
	// The domain name of the SMTP server. Do not include "http://" in the domain name.
	// This property may also be set to an IP address string, such as "168.144.70.227".
	// Both IPv4 and IPv6 address formats are supported.
	void put_SmtpHost(const uint16_t *newVal);
	...
	// Integrated Windows Authentication. If there is no domain, this can be left
	// empty.
	const uint16_t *smtpLoginDomain(void);
	// The Windows domain for logging into the SMTP server. Use this only if your SMTP
	// server requires NTLM authentication, which means your SMTP server uses
	// Integrated Windows Authentication. If there is no domain, this can be left
	// empty.
	void put_SmtpLoginDomain(const uint16_t *newVal);
	...
	// authentication.
	// 
	const uint16_t *smtpPassword(void);
	// The password for logging into the SMTP server. Use this only if your SMTP server
	// requires authentication. Chilkat Email.NET supports the LOGIN, PLAIN, CRAM-MD5,
	// and NTLM login methods, and it will automatically choose the most secure method
	// available. Additional login methods will be available in the future.
	...
	// authentication.
	// 
	void put_SmtpPassword(const uint16_t *newVal);
	...
	// the raw responses received from the SMTP server. This property is read-only, but
	// it may be cleared by calling ClearSmtpSessionLog.
	const uint16_t *smtpSessionLog(void);
	...
	// thentication-end-user-app-passwords
	// 
	const uint16_t *smtpUsername(void);
	// The login for logging into the SMTP server. Use this only if your SMTP server
	// requires authentication.
	// 
	// Note: In many cases, an SMTP server will not require authentication when sending
	...
	// thentication-end-user-app-passwords
	// 
	void put_SmtpUsername(const uint16_t *newVal);
	...
	// 
	bool AddPfxSourceData(CkByteData &pfxData, const uint16_t *password);
	...
	// 
	bool AddPfxSourceFile(const uint16_t *pfxFilePath, const uint16_t *password);
	...
	// 
	bool DeleteBundle(CkEmailBundleU &emailBundle);

	// Creates an asynchronous task to call the DeleteBundle method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *DeleteBundleAsync(CkEmailBundleU &emailBundle);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *DeleteByMsgnumAsync(int msgnum);
	...
	// automatically re-establish a session based on the current property settings.
	// 
	bool DeleteByUidl(const uint16_t *uidl);

	// Creates an asynchronous task to call the DeleteByUidl method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *DeleteByUidlAsync(const uint16_t *uidl);
	...
	// automatically re-establish a session based on the current property settings.
	// 
	bool DeleteMultiple(CkStringArrayU &uidlArray);

	// Creates an asynchronous task to call the DeleteMultiple method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *DeleteMultipleAsync(CkStringArrayU &uidlArray);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *FetchMimeByMsgnumAsync(int msgnum);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *FetchMultiple(CkStringArrayU &uidlArray);

	// Creates an asynchronous task to call the FetchMultiple method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *FetchMultipleAsync(CkStringArrayU &uidlArray);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *FetchMultipleHeaders(CkStringArrayU &uidlArray, int numBodyLines);

	// Creates an asynchronous task to call the FetchMultipleHeaders method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *FetchMultipleHeadersAsync(CkStringArrayU &uidlArray, int numBodyLines);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkStringArrayU *FetchMultipleMime(CkStringArrayU &uidlArray);

	// Creates an asynchronous task to call the FetchMultipleMime method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *FetchMultipleMimeAsync(CkStringArrayU &uidlArray);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *FetchSingleHeader(int numBodyLines, int messageNumber);

	// Creates an asynchronous task to call the FetchSingleHeader method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *FetchSingleHeaderAsync(int numBodyLines, int messageNumber);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *FetchSingleHeaderByUidl(int numBodyLines, const uint16_t *uidl);

	// Creates an asynchronous task to call the FetchSingleHeaderByUidl method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *FetchSingleHeaderByUidlAsync(int numBodyLines, const uint16_t *uidl);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *GetAllHeaders(int numBodyLines);

	// Creates an asynchronous task to call the GetAllHeaders method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetAllHeadersAsync(int numBodyLines);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkStringArrayU *GetBadEmailAddrs(void);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *GetHeaders(int numBodyLines, int fromIndex, int toIndex);

	// Creates an asynchronous task to call the GetHeaders method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetHeadersAsync(int numBodyLines, int fromIndex, int toIndex);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetMailboxCountAsync(void);
	...
	// Returns an XML document with information about the emails in a POP3 mailbox. The
	// XML contains the UIDL and size (in bytes) of each email in the mailbox.
	const uint16_t *getMailboxInfoXml(void);
	// Returns an XML document with information about the emails in a POP3 mailbox. The
	// XML contains the UIDL and size (in bytes) of each email in the mailbox.
	const uint16_t *mailboxInfoXml(void);

	// Creates an asynchronous task to call the GetMailboxInfoXml method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetMailboxInfoXmlAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetMailboxSizeAsync(void);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkCertU *GetPop3SslServerCert(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *IsSmtpDsnCapableAsync(void);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *LoadEml(const uint16_t *emlFilename);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *LoadMbx(const uint16_t *mbxFileName);

	// Creates and loads an email from a MIME string. Returns a null reference on
	// failure.
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *LoadMime(const uint16_t *mimeText);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *LoadQueuedEmail(const uint16_t *path);
#endif
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *LoadXmlEmail(const uint16_t *filename);

	// Loads an XML string containing a single email and returns an email object.
	// Returns a null reference on failure.
	// The caller is responsible for deleting the object returned by this method.
	CkEmailU *LoadXmlEmailString(const uint16_t *xmlString);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *LoadXmlFile(const uint16_t *filename);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkEmailBundleU *LoadXmlString(const uint16_t *xmlString);

#if defined(CK_MX_INCLUDED)
	// Performs a DNS MX lookup to return the mail server hostname based on an email
	// address.
	bool MxLookup(const uint16_t *emailAddress, CkString &outStrHostname);
	// Performs a DNS MX lookup to return the mail server hostname based on an email
	// address.
	const uint16_t *mxLookup(const uint16_t *emailAddress);
#endif
	...
	// The caller is responsible for deleting the object returned by this method.
	CkStringArrayU *MxLookupAll(const uint16_t *emailAddress);
#endif
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *OpenSmtpConnectionAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *Pop3AuthenticateAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *Pop3BeginSessionAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *Pop3EndSessionAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *Pop3EndSessionNoQuitAsync(void);
	...
	// "Shift_JIS", etc.)
	bool Pop3SendRawCommand(const uint16_t *command, const uint16_t *charset, CkString &outStr);
	// Sends a raw command to the POP3 server and returns the POP3 server's response.
	// If non-us-ascii characters are included in command, then charset indicates the charset
	// to be used in sending the command (such as "utf-8", "ansi", "iso-8859-1",
	// "Shift_JIS", etc.)
	const uint16_t *pop3SendRawCommand(const uint16_t *command, const uint16_t *charset);

	// Creates an asynchronous task to call the Pop3SendRawCommand method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *Pop3SendRawCommandAsync(const uint16_t *command, const uint16_t *charset);

	// A quick way to send an email to a single recipient without having to explicitly
	// create an email object.
	bool QuickSend(const uint16_t *fromAddr, const uint16_t *toAddr, const uint16_t *subject, const uint16_t *body, const uint16_t *smtpServer);

	// Creates an asynchronous task to call the QuickSend method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *QuickSendAsync(const uint16_t *fromAddr, const uint16_t *toAddr, const uint16_t *subject, const uint16_t *body, const uint16_t *smtpServer);
	...
	// 
	bool RenderToMime(CkEmailU &email, CkString &outStr);
	// When an email is sent by calling SendEmail, it is first "rendered" according to
	// the values of the email properties and contents. It may be digitally signed,
	// encrypted, values substituted for replacement patterns, and header fields "Q"or
	// "B" encoded as needed based on the email. The RenderToMime method performs the
	...
	bool RenderToMimeBytes(CkEmailU &email, CkByteData &outBytes);

	// The same as RenderToMime, except the MIME is rendered into renderedMime. The rendered
	// MIME is appended to renderedMime.
	bool RenderToMimeSb(CkEmailU &email, CkStringBuilderU &renderedMime);
	...
	// 
	bool SendBundle(CkEmailBundleU &bundle);

	// Creates an asynchronous task to call the SendBundle method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendBundleAsync(CkEmailBundleU &bundle);
	...
	// 
	bool SendMime(const uint16_t *fromAddr, const uint16_t *recipients, const uint16_t *mimeSource);

	// Creates an asynchronous task to call the SendMime method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendMimeAsync(const uint16_t *fromAddr, const uint16_t *recipients, const uint16_t *mimeSource);
	...
	bool SendMimeBd(const uint16_t *fromAddr, const uint16_t *recipients, CkBinDataU &mimeData);

	// Creates an asynchronous task to call the SendMimeBd method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendMimeBdAsync(const uint16_t *fromAddr, const uint16_t *recipients, CkBinDataU &mimeData);
	...
	// (unless the SMTP server enforces policies that require them to be the same).
	// 
	bool SendMimeBytes(const uint16_t *fromAddr, const uint16_t *recipients, CkByteData &mimeSource);

	// Creates an asynchronous task to call the SendMimeBytes method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendMimeBytesAsync(const uint16_t *fromAddr, const uint16_t *recipients, CkByteData &mimeSource);

#if defined(CK_SMTPQ_INCLUDED)
	// This method is the samem as SendMimeQ, except the MIME is passed in a byte array
	// argument instead of a string argument.
	bool SendMimeBytesQ(const uint16_t *from, const uint16_t *recipients, CkByteData &mimeData);
#endif
	...
	// 
	bool SendMimeQ(const uint16_t *fromAddr, const uint16_t *recipients, const uint16_t *mimeSource);
#endif

	// Same as SendMime, but the recipient list is read from a text file (distListFilename)
	// containing one email address per line.
	bool SendMimeToList(const uint16_t *fromAddr, const uint16_t *distListFilename, const uint16_t *mimeSource);

	// Creates an asynchronous task to call the SendMimeToList method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendMimeToListAsync(const uint16_t *fromAddr, const uint16_t *distListFilename, const uint16_t *mimeSource);
	...
	// does not provide pre-built binaries for the SMTPQ Windows Service.
	// 
	bool SendQ2(CkEmailU &email, const uint16_t *queueDir);
#endif

	// Send the same email to a list of email addresses.
	bool SendToDistributionList(CkEmailU &emailObj, CkStringArrayU &recipientList);

	// Creates an asynchronous task to call the SendToDistributionList method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SendToDistributionListAsync(CkEmailU &emailObj, CkStringArrayU &recipientList);
	...
	// 
	bool SetDecryptCert2(CkCertU &cert, CkPrivateKeyU &privateKey);
	...
	bool SetPassword(const uint16_t *protocol, CkSecureStringU &password);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SmtpAuthenticateAsync(void);
	...
	// 
	bool SmtpSendRawCommand(const uint16_t *command, const uint16_t *charset, bool bEncodeBase64, CkString &outStr);
	// Sends a raw command to the SMTP server and returns the SMTP server's response.
	// If non-us-ascii characters are included in command, then charset indicates the charset
	// to be used in sending the command (such as "utf-8", "ansi", "iso-8859-1",
	// "Shift_JIS", etc.)
	...
	// Otherwise the raw response is returned.
	// 
	const uint16_t *smtpSendRawCommand(const uint16_t *command, const uint16_t *charset, bool bEncodeBase64);

	// Creates an asynchronous task to call the SmtpSendRawCommand method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SmtpSendRawCommandAsync(const uint16_t *command, const uint16_t *charset, bool bEncodeBase64);
	...
	// 
	bool SshAuthenticatePk(const uint16_t *sshLogin, CkSshKeyU &sshUsername);

	// Creates an asynchronous task to call the SshAuthenticatePk method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SshAuthenticatePkAsync(const uint16_t *sshLogin, CkSshKeyU &sshUsername);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkStringArrayU *TransferMultipleMime(CkStringArrayU &uidlArray);

	// Creates an asynchronous task to call the TransferMultipleMime method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *TransferMultipleMimeAsync(CkStringArrayU &uidlArray);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *VerifyPopConnectionAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *VerifyPopLoginAsync(void);
	...
	// 
	bool VerifyRecips(CkEmailU &email, CkStringArrayU &badAddrs);

	// Creates an asynchronous task to call the VerifyRecips method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *VerifyRecipsAsync(CkEmailU &email, CkStringArrayU &badAddrs);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *VerifySmtpConnectionAsync(void);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *VerifySmtpLoginAsync(void);
